<template>
  <v-card style="height: 200px;" color="#1F8A70">
    <v-card-title class="text-h4 font-weight-black text-white mt-6 ml-4">商品销售记录</v-card-title>
...
import {getOrderDetailByGoodIdForAdmin} from "../../../../network/orderDetail";
...
export default {
  ...
  setup() {
    ...
    const init = () => {
      getOrderDetailByGoodIdForAdmin(route.query.id, page.value).then(res=>{
