...
@WebFilter(filterName = "loginFilter2", urlPatterns = {"/saler/*"})
public class JWTFilter2 implements Filter {
    ...
    public String resolveToken(HttpServletRequest httpServletRequest){
        String bearerToken = httpServletRequest.getHeader("Authorization2");
...
//            }
            if (JwtUtil.checkToken(jwt)) {
                ...
                servletRequest.setAttribute("salername", username);
